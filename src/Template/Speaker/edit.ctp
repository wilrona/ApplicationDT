...
<div class="modal-header">
    <h4 class="modal-title">Modification d'un speaker</h4>
</div>
...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="col-lg-5">
            <?= $this->Html->image($speaker->avatar, ['class' => 'img-rounded img-responsive', 'id ' => 'img-photo', 'style' => 'width:320px;']); ?>
            <input type="hidden" name="photo" value="<?= $speaker->avatar; ?>"/>
        </div>
    </div>
