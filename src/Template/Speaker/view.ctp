<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('List Speaker'), ['action' => 'index']) ?> </li>
...
<div class="speaker view large-9 medium-8 columns content">
    <h3><?= h($speaker->id) ?></h3>
    ...
    <div class="related">
        ...
        <?php if (!empty($speaker->intervention)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($speaker->intervention as $intervention): ?>
            <tr>
